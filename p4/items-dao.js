...
const itemsDaoSqlite = require('./items-dao-sqlite3');
/**
...
function findById(id) {
  return itemsDaoSqlite.findById(id);
}
...
function findByDescription(partialDescription) {
  return itemsDaoSqlite.findByDescription(partialDescription);
}
...
function findByUpc(upc) {
  return itemsDaoSqlite.findByUpc(upc);
}
